...
| 1 | astral-go | `/home/intern0/work/astralp2p/astral-go/main` @ `02ba1c1` (the commit the node pins) |
| 2 | astrald server | `/home/intern0/work/astralp2p/astrald/master` @ `f6d3de71` — authoritative for session semantics the client never exercises |
