...
reachable without the caller constructing one. A test asserts `client.dir is
client.dir` for every module, so a new module that forgets the property fails the
suite as well.
...
__all__ = ["Apphost", "Dir", "ModuleClient", "apphost", "base", "dir"]
