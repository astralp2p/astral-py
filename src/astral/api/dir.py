...
line 12 at astrald `993ffac0`); the required
...
ones. Line numbers below are pinned to astrald `993ffac0` and astral-go
`bf8542a`, the revisions `tests/reference.py` pins, and no citation names
another revision.
"""
