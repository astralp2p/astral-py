...
Tier 2, three ops, and **zero astral-go client**: `api/ip` at `6ea26c7` is
...
`6ea26c7`), and its reader takes whatever length arrives. The three payloads
...
`6ea26c7`): `net.ParseIP` answers nil for anything it cannot read, and the nil
