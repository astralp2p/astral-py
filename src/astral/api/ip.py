...
Tier 2, three ops, and **zero astral-go client**: `api/ip` at `5b1d282` is
...
`5b1d282`), and its reader takes whatever length arrives. The three payloads
...
`5b1d282`): `net.ParseIP` answers nil for anything it cannot read, and the nil
...
Source citations are pinned to astral-go `5b1d282` and astrald `d5bb0bbd`.
"""
