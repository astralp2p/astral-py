...
Tier 2, three ops, and **zero astral-go client**: `api/ip` at `02ba1c1` is
...
`02ba1c1`), and its reader takes whatever length arrives. The three payloads
...
`02ba1c1`): `net.ParseIP` answers nil for anything it cannot read, and the nil
...
Source citations are pinned to astral-go `02ba1c1` and astrald `f6d3de71`.
"""
